  ...
  <Accordion type="single" collapsible>
    <AccordionItem value="item-1">
      ...
      <AccordionContent class="flex-column">
        <NpcTable :players="players.list" class="mb-4" @delete="removeCharacter" @edit="editCharacter"
   />
        <div class="flex justify-end">
          <NpcCreation :button_title="button_name" :playerToEdit="playerToEdit" v-model:open="sheetOpen"
            @create="addCharacter" />
        </div>
      </AccordionContent>
    </AccordionItem>
