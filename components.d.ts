...
declare module 'vue' {
  export interface GlobalComponents {
    ...
    IRadixIconsFile: typeof import('~icons/radix-icons/file')['default']
    IRadixIconsHeart: typeof import('~icons/radix-icons/heart')['default']
    IRadixIconsIRadixIconsCardstackplus: typeof import('~icons/radix-icons/i-radix-icons-cardstackplus')['default']
    IRadixIconsIRadixIconsCardStackPlus: typeof import('~icons/radix-icons/i-radix-icons-card-stack-plus')['default']
